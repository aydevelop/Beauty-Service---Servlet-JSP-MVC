...
public class AuthLoginGetAction extends Base implements Action {
    public AuthLoginGetAction(String view, HttpServletRequest request, HttpServletResponse response) {
